...
fn make_message(input: &str) {
    match input {
        ...
        "11" => worked_problems::euler_11::euler11_example().to_string(),
        "12" => worked_problems::euler_12::euler12_example().to_string(),
        "13" => worked_problems::euler_13::euler13_example().to_string(),
        "14" => worked_problems::euler_14::euler14_example().to_string(),
        "15" => worked_problems::euler_15::euler15_example().to_string(),
        "16" => worked_problems::euler_16::euler16_example().to_string(),
